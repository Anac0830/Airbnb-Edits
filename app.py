...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-process:disabled { background: var(--gray-300); box-shadow: none; cursor: not-allowed; transform: none; }
        ...
        .spin { width: 16px; height: 16px; border: 2px solid currentColor; border-top-color: transparent; border-radius: 50%; animation: spin 0.7s linear infinite; flex-shrink: 0; }
        @keyframes spin { to { transform: rotate(360deg); } }
        .tips { background: #fffbeb; border: 1px solid #fde68a; border-radius: 10px; padding: 16px 18px; }
        .tips-title { font-size: 13px; font-weight: 700; color: #92400e; margin-bottom: 8px; display: flex; align-items: center; gap: 6px; }
        .tips ul { padding-left: 18px; }
        .tips li { font-size: 13px; color: #78350f; margin-bottom: 4px; line-height: 1.5; }
        footer { text-align: center; padding: 24px; color: var(--gray-400); font-size: 13px; border-top: 1px solid var(--gray-200); }
        ...
        for old_text, new_text in zip(finds, replaces):
            ...
            for page in doc:
                ...
                for inst in text_instances:
                    # Captura de estilo original para mantener el tamaño
                    ...
                    # MODIFICACIÓN: Se usa 'helv-bold' para forzar la negrita
                    page.insert_text(inst.tl, new_text, fontsize=font_size, fontname="helv-bold", color=(0, 0, 0))
